...
-   create a smaller set of features from the existing that capture the "information in the original predictors
...
## Other manifold learning methods {.incremental}

-   t-SNE - t-distributed stochastic neighbor embedding (only used for viz)
-   Isomap
...
-   **Principal Components Analysis (PCA)**
    ...
    -   Mathematical basis - eigenvectors and eigenvalues
    -   Principal components regression (PCR)
    -   Interpreting loadings, scores, and biplots

-   **Nonlinear dimension reduction**

    -   UMAP, neural networks

    -   Viz examples, no theory

-   **Class experiments/examples**

    -   `meatspec`: manual PCR with many correlated predictors
    -   curse of dimanensionality simulation
    -   `USArrests`: correlation matrix vs $X^TX$ eigen decomp
